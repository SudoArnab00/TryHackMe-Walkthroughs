---
title: Windows Local Persistence – Backdooring Files
---
...
- Backdoor script in **C:\Windows\System32** or any other sneaky location :
...
- As soon as you open the **calc** icon on victim machine, you will see a connection formed on attacker machine terminal. 
...
- To hijack the extension, we will change the command with our script that executes a backdoor and then opens the file. Let's make a script: (my script name: **sc.ps1**)
...
- Edited the register and replaced it with our command to open the script

![WLP18](/img/WLP17.png)

- On the attacker machine, lets listen to the port 4448. Run on terminal:

`nc -lvp 4448`

- As soon as you open a .txt file on the victim machine attached, a reverse shell will be established with your attacker machine. Retrieve flag using `flag6.exe`
